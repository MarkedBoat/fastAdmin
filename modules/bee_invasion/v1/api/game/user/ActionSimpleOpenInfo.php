...
class ActionSimpleOpenInfo extends GameBaseAction
{
    public function run()
    {
        ...
        {
            return $this->dispatcher->createInterruption(AdvError::request_param_verify_fail['code'], AdvError::request_param_verify_fail['msg'], false);
        }
