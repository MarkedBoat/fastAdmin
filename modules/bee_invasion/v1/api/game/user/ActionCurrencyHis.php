...
class ActionCurrencyHis extends GameBaseAction
{
    ...
    public function getInnerDataUpdateTimeKeys()
    {
        ...
        if ($item_code)
        {
            $list[] = ApiCache::model()->getCacheKey('ChangeFlagUserCurrency', ['user_id' => $this->user->id]);
    ...
    public function run()
    {
        ...
        $dao = UserCurrencyHis::model()->addSort('id', 'desc');
