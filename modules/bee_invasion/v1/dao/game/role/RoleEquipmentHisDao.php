 ...
 * @property string item_code 装备 code
 * @property int item_amount 本次   数量
 ...
 */
class RoleEquipmentHisDao extends ORM
{
    public $id            = null;
    public $src           = 0;
    public $src_id        = 0;
    ...
    public static $tableName    = 'bi_game_role_equipment_his';
    public static $pk           = 'id';
