...
/**
 * @property int id
 * @property string item_class 实物归类
 * @property string item_name 实物名称
 * @property string item_code 实物code
 * @property string item_icon 实物图标
...
class ObjectDao extends ORM
{
    ...
    public static $tableName    = 'bi_object';
    public static $pk           = 'id';
