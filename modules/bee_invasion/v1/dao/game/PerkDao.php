...
/**
 * @property int id
 * @property string item_name 技能名
 * @property string item_code 技能 标识 code
 * @property string item_icon 技能图标
...
class PerkDao extends ORM
{
    ...
    public static $tableName    = 'bi_game_perk';
    public static $pk           = 'id';
