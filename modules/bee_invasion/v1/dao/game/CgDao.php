...
/**
 * @property int id
 * @property string item_name 消耗性 道具名   consumer goods name
 * @property string item_code 道具code
 * @property string item_icon 道具图标
 ...
 * @property string effect 使用后效果
 * @property int is_ok 是否正常  1:正常  2:被封禁
 * @property string create_time
 * @property string update_time
 */
class CgDao extends ORM
{
    public $id             = null;
    public $item_name      = '';
    public $item_code      = '';
    ...
    public static $tableName    = 'bi_game_cg';
    public static $pk           = 'id';
