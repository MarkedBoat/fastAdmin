 ...
 * @property string item_code 通货code
 * @property int item_amount 本次  消耗品 数量
 * @property int curr_amount 当前现有数量  currenct  amount
 ...
 * @property int is_rollback 是否被撤回
 * @property string create_time
 * @property string update_time ON UPDATE CURRENT_TIMESTAMP
 */
class UserCurrencyHisDao extends ORM
{
    public $id            = null;
    public $src           = '';
    public $src_id        = '';
    ...
    public $src_open_id   = '';
    public $src_remark    = '';
    public $is_rollback   = 2;
    public $create_time   = null;
    public $update_time   = null;


    public static $_fields_str;
    public static $tableName    = 'bi_user_currency_his';
    public static $pk           = 'id';
    public static $field_config = [
        ...
        'item_amount'   => ['db_type' => 'bigint', 'length' => 0, 'def' => 0, 'pro_def' => 0],
        'curr_amount'   => ['db_type' => 'bigint', 'length' => 0, 'def' => 0, 'pro_def' => 0],
        'expect_amount' => ['db_type' => 'bigint', 'length' => 0, 'def' => 0, 'pro_def' => 0],
        ...
        'src_remark'    => ['db_type' => 'varchar', 'length' => 1024, 'def' => '', 'pro_def' => ''],
        'is_rollback'   => ['db_type' => 'tinyint', 'length' => 0, 'def' => 2, 'pro_def' => 2],
