 ...
 * @property string relation_left_field 关联表 left表值的字段名
 * @property string relation_right_field 关联表 right表值的字段名
 ...
 * @property string relation_res_key 关联结果 以 xx 为key
 * @property string relation_res_title 关联结果 title
 * @property string relation_type 关联关系 has_one ,has_many  不考虑 多对一 和 多对多
 * @property string query_input_type 查询数据类型
 ...
 * @property int filter_val_items_length right表作为选项的最大个数，比如说right 是标签，作为选项可能几千个还好，但是万一是几十万个呢？ 必须设置一个上限
...
class DbRelationDao extends ORM
{
    ...
    public $relation_left_field='';
    public $relation_right_field='';
    public $relation_ext_field='';
    public $relation_ext_field_val='';
    public $relation_res_key='';
    public $relation_res_title='';
    ...
    public $filter_val_items_length=100;
    public $is_ok=1;
    ...
    public static $field_config=[
        ...
        'relation_left_field'=>['db_type'=>'varchar','length'=>32,'def'=>'','pro_def'=>''],
        'relation_right_field'=>['db_type'=>'varchar','length'=>32,'def'=>'','pro_def'=>''],
        'relation_ext_field'=>['db_type'=>'varchar','length'=>32,'def'=>'','pro_def'=>''],
        'relation_ext_field_val'=>['db_type'=>'varchar','length'=>32,'def'=>'','pro_def'=>''],
        'relation_res_key'=>['db_type'=>'varchar','length'=>32,'def'=>'','pro_def'=>''],
        'relation_res_title'=>['db_type'=>'varchar','length'=>32,'def'=>'','pro_def'=>''],
        'relation_type'=>['db_type'=>'varchar','length'=>32,'def'=>'','pro_def'=>''],
        ...
        'filter_val_items_length'=>['db_type'=>'smallint','length'=>0,'def'=>100,'pro_def'=>100],
